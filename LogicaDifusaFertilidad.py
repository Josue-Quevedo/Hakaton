# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 18:10:23 2024
...
# Paso 1: Definir las variables de entrada y salida del sistema difuso
...
# Paso 2: Definir las funciones de membresía para cada variable
# (Esto es específico para cada aplicación y puede requerir conocimiento experto)
# Aquí se definen funciones de membresía aleatorias como ejemplo
...
# (Esto también es específico para cada aplicación y puede requerir conocimiento experto)
# Aquí se definen reglas aleatorias como ejemplo
...
# Paso 5: Crear un simulador para el sistema de control difuso
simulador = ctrl.ControlSystemSimulation(sistema_control)

# Paso 6: Graficar las funciones de membresía de las variables de entrada
fig, axes = plt.subplots(3, 2, figsize=(10, 10))
axes = axes.flatten()
for i, variable in enumerate([humedad, ph, potasio, fosforo, nitrogeno]):
    variable.view(ax=axes[i])

# Paso 7: Evaluar el sistema de control difuso y graficar en 3D
# (Esto requiere valores específicos para cada variable de entrada)
# Aquí se evalúa el sistema con valores aleatorios como ejemplo
